...
export function getFallbackSkillRoots(workdir: string) {
  ...
  const roots = [
    ...
    resolve(workdir, '..', 'clawdis', 'Skills'),
    resolve(workdir, '..', 'bot', 'skills'),
    resolve(workdir, '..', 'bot', 'Skills'),
    resolve(workdir, '..', 'hanzo-bot', 'skills'),
    resolve(workdir, '..', 'hanzo-bot', 'Skills'),
    ...
    resolve(home, 'Library', 'Application Support', 'bot', 'skills'),
    resolve(home, 'Library', 'Application Support', 'bot', 'Skills'),
    resolve(home, 'Library', 'Application Support', 'clawdis', 'skills'),
    resolve(home, 'Library', 'Application Support', 'clawdis', 'Skills'),
    resolve(home, 'Library', 'Application Support', 'hanzo-bot', 'skills'),
    resolve(home, 'Library', 'Application Support', 'hanzo-bot', 'Skills'),
